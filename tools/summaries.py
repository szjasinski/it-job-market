...
def display_employers_with_most_offers(main_df):
    df = main_df.copy()
...
def display_offers_with_the_highest_max_salary(main_df):
    df = main_df.copy()
...
def display_offers_with_the_lowest_min_salary(main_df):
    df = main_df.copy()
...
def display_top_employers_by_average_max_salary(main_df):
    df = main_df.copy()
